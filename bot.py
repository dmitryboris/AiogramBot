...
from handlers import start, subscription_info, subscription, cabinet, paid
...
async def main():
    ...
    dp = Dispatcher()
    dp.include_routers(start.router, cabinet.router, subscription_info.router, paid.router, subscription.router)
